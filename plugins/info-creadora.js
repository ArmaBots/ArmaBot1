...
*IG*
*https://www.instagram.com/arm.dzn*
...
correo = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : official[3][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/arm.dzn' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.instagram.com/arm.dzn' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
